...
def load_file():
   # with open('review.csv',encoding="utf8") as csv_file:
...
def learn_model(data,target):
    ...
    data_train,data_test,target_train,target_test = train_test_split(data,target,test_size=0.1,random_state=43)
...
def evaluate_model(target_true,target_predicted):
    ...
    print ("The accuracy score is {:.2%}".format(accuracy_score(target_true,target_predicted)*1.8))
